...
const ContactInfo = () => {
  return (
    <div className="flex flex-col gap-4">
      {/* Address */}
      <div className="flex gap-4 rounded-xl border border-[#dce0e5] dark:border-[#2a3441] bg-white dark:bg-[#1a232e] p-5 shadow-sm">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-[#637588] dark:text-[#9ba8b8] text-sm font-normal leading-normal">
