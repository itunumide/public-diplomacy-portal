  ...
  return (
    <footer className="w-full bg-background-light dark:bg-background-dark border-t border-slate-200 dark:border-slate-800">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <div className="flex gap-4 mt-2">
              <a
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-white dark:bg-slate-800 text-slate-500 hover:text-primary hover:bg-primary/10 transition-colors border border-slate-200 dark:border-slate-700"
                href="#"
              >
          ...
          <div className="lg:col-span-3 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              <form className="flex w-full items-stretch rounded-lg mt-1">
                <input
                  className="form-input flex-1 min-w-0 rounded-l-lg border border-r-0 border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white px-3 py-2 text-sm focus:ring-1 focus:ring-primary focus:border-primary"
        ...
        {/* Bottom Bar */}
        <div className="mt-16 pt-8 border-t border-slate-200 dark:border-slate-700 flex flex-col md:flex-row justify-between items-center gap-4">
